...
__all__ = [
    ...
    "Copilot", "AsyncCopilot",
    "ChatCompletion", "ChatCompletionChunk", "ChatMessage", "Choice",
    "ChoiceDelta", "ChunkChoice", "ModelsPage",
    "APIError", "APIConnectionError", "RateLimitError", "AuthenticationError",
    "BadRequestError",
    # engine + types (advanced)
    "CopilotProvider", "CopilotClient", "Edition", "get_edition",
    "Model", "ModelInfo", "ConversationRef", "Delta", "Progress", "Final", "Event",
    "Citation", "Suggestion", "Throttling",
    "CopilotError", "ProtocolError", "ThrottledError", "TransportError",
    "ConversationLimitError", "ChallengeError", "CaptchaRequired",
]
